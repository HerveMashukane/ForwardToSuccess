...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-brand-background/90 backdrop-blur-md shadow-md px-6 py-4 flex items-center justify-between">
      {/* LOGO */}
      <div className="text-heading3 font-bold text-brand-primary">
        ForwardToSuccess
      </div>
      ...
      >
        ...
        <button className="bg-brand-secondary hover:bg-brand-secondary-hover text-white py-btnY px-btnX rounded-btnRadius shadow-btnShadow flex items-center justify-center gap-2 mt-2">
          <i className="bi bi-heart-fill"></i>
          Donate
        </button>
      </div>
