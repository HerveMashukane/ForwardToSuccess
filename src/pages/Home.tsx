      ...
      <section className="relative px-6 py-16 sm:py-20 md:px-16 lg:py-28">
        <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10 max-w-xl space-y-6">
            ...
            <h2
              className={`${HERO_PHRASES[textIndex].color} text-2xl sm:text-3xl font-semibold h-12 animate-fade-up animate-delay-100`}
            >
              {displayText}
            ...
            <p className="text-brand-secondary sm:text-lg animate-fade-up animate-delay-200">
              Master languages, digital skills, and practical subjects with real-world,
              hands-on training designed to accelerate your growth.
            </p>

            {/* CTA */}
            <div className="flex flex-col sm:flex-row gap-4 mt-6 animate-fade-up animate-delay-300">
            ...
            {/* STATS */}
            <div className="flex flex-wrap gap-6 text-gray-500 mt-8 animate-fade-up animate-delay-400">
          ...
          <div className="relative flex justify-center items-center">
            ...
            {/* FLOATING ELEMENTS */}
            <svg className="absolute top-10 left-16 h-6 w-6 text-indigo-300 animate-float-diagonal" viewBox="0 0 24 24">
              <circle cx="12" cy="12" r="6" />
            </svg>

            <svg className="absolute bottom-16 right-20 h-5 w-5 text-pink-300 animate-float-diagonal" viewBox="0 0 24 24">
              <polygon points="12,2 22,22 2,22" />
            </svg>

            <svg className="absolute top-24 right-12 h-4 w-4 text-yellow-400 animate-float-diagonal" viewBox="0 0 24 24">
